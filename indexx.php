...
<li class="nav-item">
    ...
    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
        <div class="bg-white py-2 collapse-inner rounded">
            ...
            <a class="collapse-item list-users" href="user.php">Liste des utilisateurs</a>
            <a class="collapse-item add-users" href="user.php">Ajout des utilisateurs</a>
        </div>
    </div>
</li>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button"
                                data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                <span class="mr-2 d-none d-lg-inline text-gray-600 small">ayoub aouedi</span>
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-primary text-uppercase mb-1">
                                                Gains (mensuels)</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">125,20 Dt</div>
                                        </div>
                                        <div class="col-auto">
                                    ...
                                    <div class="row no-gutters align-items-center">
                                        <div class="col mr-2">
                                            <div class="text-xs font-weight-bold text-success text-uppercase mb-1">
                                                Gains (annuels)</div>
                                            <div class="h5 mb-0 font-weight-bold text-gray-800">672,95 Dt</div>
                                        </div>
                                        <div class="col-auto">
                            ...
                            <div class="card shadow mb-4">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="mt-4 text-center small">
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-primary"></i> Administrateur
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-success"></i> Étudiant
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-info"></i> Responsable des cours
                                        </span>
                                        <span class="mr-2">
                                            <i class="fas fa-circle text-info"></i> Responsable des événements
                                        </span>
                                    </div>
                                </div>
                            </div>
