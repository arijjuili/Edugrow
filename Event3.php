...
if (isset($_POST['add']) || isset($_POST['edit'])) {
    ...
    $Event->setImg($imgPath); // Set the image path

    if (isset($_POST['add'])) {
        $EventC->addEvent($Event);
    } else if (isset($_POST['edit'])) {
        $Event->setIdE($_POST['idE']);
    ...
    <tr>
      ...
      <td>
        <div class="dropdown">
          ...
          <a href="?edit=<?php echo $Event['idE']; ?>" class="btn btn-sm btn-secondary me-2"
...
function validateForm() {
    ...
    return true;
          ...
          <?php if (isset($_GET['edit'])): ?>
            <?php $EventToEdit = $EventC->getEventbyID($_GET['edit']); ?>
            <form method="POST" action="process_event.php">
              <input type="hidden" name="idE" value="<?php echo $EventToEdit['idE']; ?>">
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="Nom" name="Nom"
                  value="<?php echo $EventToEdit['Nom']; ?>">
              </div>
              ...
              <div class="mb-3">
                ...
                <input type="Date" class="form-control" id="Date" name="Date"
                  value="<?php echo $EventToEdit['Date']; ?>">
              </div>
              ...
              <div class="mb-3">
                ...
                <input type="text" class="form-control" id="Location" name="Location"
                  value="<?php echo $EventToEdit['Location']; ?>">
                  </div>
    ...
    <div class="mb-3">
      ...
      <img src="<?php echo $EventToEdit['img']; ?>" alt="Current Image" style="max-width: 100px;">
    </div>
