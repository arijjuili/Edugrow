  ...
  <body>
    ...
    <main class="main" id="top">
      ...
      <nav class="navbar navbar-expand-lg navbar-light sticky-top py-3 d-block" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a class="navbar-brand" href="index.html"><img src="assets/img/gallery/edugrow(2).png" height="55" alt="logo" /></a>
          ...
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto pt-2 pt-lg-0 font-base">
              ...
              <li class="nav-item px-2"><a class="nav-link" aria-current="page" href="cours.html">Cours</a></li>
              <li class="nav-item px-2"><a class="nav-link" aria-current="page" href="Event.php">Events</a></li>
        ...
        <div class="container">
          <div class="row align-items-center">
            ...
            <div class="col-md-7 col-lg-6 text-md-start text-center py-6">
              <h4 class="fw-bold font-sans-serif">Bienvenue </h4>
              <h1 class="fs-6 fs-xl-7 mb-5">Transformez Votre Ecran En Une Fenetre Sur Le Savoir.</h1><a class="btn btn-primary me-2" href="#!" role="button">Commencez votre cours en ligne !</a><a class="btn btn-outline-secondary" href="#!" role="button">A propos de nous </a>
            </div>
          </div>
        </div>      
      </section>
