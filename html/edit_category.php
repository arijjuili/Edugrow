...
if(isset($_GET['idC'])) {
    $catergoryID = $_GET['idC'];
    
    // Retrieve the response details from the database
    $Category = $CategoryC->getCategoryById($catergoryID);
 ...
 // Check if the response exists
    ...
    if($Category) {
        ...
        <form method="POST" action="process_category.php">
            ...
            <div class="mb-3">
                <label for="Nom" class="form-label">Nbr_events</label>
                <input type="text" class="form-control" id="Nbr_events" name="Nbr_events" 
                value="<?php echo $Category['Nbr_events']; ?>">
            </div>
