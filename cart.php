...
if (isset($_SESSION['cart']) && !empty($_SESSION['cart'])) {
    ...
    // Get the list of products based on the IDs in the cart session
    $listeProduitPanier = $produitC->getProduitsByIds($_SESSION['cart']);
...
<html lang="en-US" dir="ltr">
  ...
  <body>
    <main class="main" id="top">
      ...
      <section>
        ...
        <div class="container">
          <div class="row">
            <h1 class="text-center mb-5"> Your Chart</h1>
			<div class="row">
  <?php foreach ($listeProduitPanier as $produit) { ?>
  ...
  <?php } ?>
  <form method="post" action="addcommande.php?produit_id=<?php echo $produit['id']; ?>">
                        <button type="submit" name="add_commande" class="btn btn-primary">Pass Commande</button>
                    </form>
</div>
